defmodule NdbRestApiWeb.AdminAuth do
  use NdbRestApiWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_ndb_rest_api_web_admin_remember_me"
  ...
  def log_out_admin(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      NdbRestApiWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_admin:
      ...
      defmodule NdbRestApiWeb.PageLive do
        use NdbRestApiWeb, :live_view

        on_mount {NdbRestApiWeb.AdminAuth, :mount_current_admin}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{NdbRestApiWeb.AdminAuth, :ensure_authenticated}] do
